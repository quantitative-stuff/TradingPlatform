use crate::types::{Exchange, OrderBookUpdate, Trade, Timestamp, Side, PriceLevel};
...
impl UdpReceiver {
    ...
    async fn process_packet(
        ...
        if header.sequence > 0 && header.sequence != *last_sequence + 1 {
            warn!("Packet loss detected: expected {}, got {}",
                  *last_sequence + 1, header.sequence);
        }
